...
description = """
moudra API helps you do awesome stuff. 🚀
"""
...
app = FastAPI(
    ...
    terms_of_service="http://moudra.com/terms/",
    contact={
        "name": "matejkratochvil",
        "url": "http://moudra.com/contact/",
        "email": "matejkratochvil@moudra.com",
    },
    license_info={
        "name": "The Unlicense",
